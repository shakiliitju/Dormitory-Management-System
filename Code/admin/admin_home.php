...
<header>
	<div class="container agile-banner_nav">
		<nav class="navbar navbar-expand-lg navbar-light bg-light">
			...
			<h1><a class="navbar-brand" href="admin_home.php">DMS<span class="display"></span></a></h1>
          ...
          <li class="nav-item">
						<a class="nav-link" href="create_hm.php">Staff</a>
					</li>
...
<footer class="py-5">
	<div class="container py-md-5">
		<div class="footer-logo mb-5 text-center">
			<a class="navbar-brand" href="http://www.nitc.ac.in/" target="_blank">IIT-JU</a>
		</div>
